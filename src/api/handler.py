...
def lambda_handler(event, context):
    ...
    # ── Annotate the root segment so we can filter traces by fault mode ──
    xray_recorder.current_segment().put_annotation("fault_mode", fault)
    xray_recorder.current_segment().put_annotation("request_id", request_id)
